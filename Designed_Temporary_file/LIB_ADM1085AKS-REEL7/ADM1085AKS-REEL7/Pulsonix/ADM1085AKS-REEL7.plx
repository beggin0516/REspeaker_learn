...
(library Library_1
	...
	(compDef "ADM1085AKS-REEL7" (originalName "ADM1085AKS-REEL7") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "ENIN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "CEXT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "ENOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.analog.com/media/en/technical-documentation/data-sheets/ADM1085_1086_1087.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "ADM1085AKS-REEL7.stp")
